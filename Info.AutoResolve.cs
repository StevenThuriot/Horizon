...
namespace Horizon
{
    static partial class Info
    {
        ...
        public static void SetValue<T>(this T instance, string propertyOrField, object value)
        {
            Info<T>.SetValue(instance, propertyOrField, value);
        }

        public static bool TrySetValue<T>(this T instance, string propertyOrField, object value)
        {
            return Info<T>.TrySetValue(instance, propertyOrField, value);
        }
        ...
        {
            return Info<T>.Create(args);
        }

        public static bool TryCreate<T>(out T instance, params object[] args)
        {
            return Info<T>.TryCreate(out instance, args);
        }
	}
}